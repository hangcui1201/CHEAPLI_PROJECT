...
override PKGDIR = xconfig_Cheapli
...
package/%.xdc.inc package/%_xconfig_Cheapli.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Cheapli" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: Cheapli.p28FP

-include package/cfg/Cheapli_p28FP.mak
-include package/cfg/Cheapli_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Cheapli_p28FP.dep
endif
Cheapli.p28FP: package/cfg/Cheapli_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
Cheapli.p28FP package/cfg/Cheapli_p28FP.c: .libraries,28FP
endif

package/cfg/Cheapli_p28FP.c package/cfg/Cheapli_p28FP.h package/cfg/Cheapli_p28FP.xdl: override _PROG_NAME := Cheapli.x28FP
package/cfg/Cheapli_p28FP.c: package/cfg/Cheapli_p28FP.cfg
package/cfg/Cheapli_p28FP.xdc.inc: package/cfg/Cheapli_p28FP.xdl
package/cfg/Cheapli_p28FP.xdl package/cfg/Cheapli_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/Cheapli_p28FP.cfg
	-$(RM) package/cfg/Cheapli_p28FP.dep
	-$(RM) package/cfg/Cheapli_p28FP.c
	-$(RM) package/cfg/Cheapli_p28FP.xdc.inc

clean,28FP::
	-$(RM) Cheapli.p28FP
.executables,28FP .executables: Cheapli.x28FP

Cheapli.x28FP: |Cheapli.p28FP

-include package/cfg/Cheapli.x28FP.mak
Cheapli.x28FP: package/cfg/Cheapli_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/Cheapli_p28FP.o28FP   package/cfg/Cheapli_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
Cheapli.x28FP: export C_DIR=
Cheapli.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
Cheapli.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

Cheapli.test test,28FP test: Cheapli.x28FP.test

Cheapli.x28FP.test:: Cheapli.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Cheapli.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Cheapli.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,Cheapli.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Cheapli_p28FP.o28FP,copy : package/cfg/Cheapli_p28FP.o28FP
Cheapli_p28FP.s28FP,copy : package/cfg/Cheapli_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Cheapli
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Cheapli.tar.dep
endif
package/rel/xconfig_Cheapli/xconfig_Cheapli/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Cheapli/xconfig_Cheapli/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Cheapli/xconfig_Cheapli/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Cheapli/xconfig_Cheapli/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Cheapli.tar: package/rel/xconfig_Cheapli.xdc.inc package/rel/xconfig_Cheapli/xconfig_Cheapli/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Cheapli.xdc.inc,package/rel/xconfig_Cheapli.tar.dep)


release release,xconfig_Cheapli: all xconfig_Cheapli.tar
clean:: .clean
	-$(RM) xconfig_Cheapli.tar
	-$(RM) package/rel/xconfig_Cheapli.xdc.inc
	-$(RM) package/rel/xconfig_Cheapli.tar.dep
