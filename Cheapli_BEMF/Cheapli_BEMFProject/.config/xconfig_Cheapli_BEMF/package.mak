...
override PKGDIR = xconfig_Cheapli_BEMF
...
package/%.xdc.inc package/%_xconfig_Cheapli_BEMF.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Cheapli_BEMF" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: Cheapli_BEMF.p28FP

-include package/cfg/Cheapli_BEMF_p28FP.mak
-include package/cfg/Cheapli_BEMF_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Cheapli_BEMF_p28FP.dep
endif
Cheapli_BEMF.p28FP: package/cfg/Cheapli_BEMF_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
Cheapli_BEMF.p28FP package/cfg/Cheapli_BEMF_p28FP.c: .libraries,28FP
endif

package/cfg/Cheapli_BEMF_p28FP.c package/cfg/Cheapli_BEMF_p28FP.h package/cfg/Cheapli_BEMF_p28FP.xdl: override _PROG_NAME := Cheapli_BEMF.x28FP
package/cfg/Cheapli_BEMF_p28FP.c: package/cfg/Cheapli_BEMF_p28FP.cfg
package/cfg/Cheapli_BEMF_p28FP.xdc.inc: package/cfg/Cheapli_BEMF_p28FP.xdl
package/cfg/Cheapli_BEMF_p28FP.xdl package/cfg/Cheapli_BEMF_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/Cheapli_BEMF_p28FP.cfg
	-$(RM) package/cfg/Cheapli_BEMF_p28FP.dep
	-$(RM) package/cfg/Cheapli_BEMF_p28FP.c
	-$(RM) package/cfg/Cheapli_BEMF_p28FP.xdc.inc

clean,28FP::
	-$(RM) Cheapli_BEMF.p28FP
.executables,28FP .executables: Cheapli_BEMF.x28FP

Cheapli_BEMF.x28FP: |Cheapli_BEMF.p28FP

-include package/cfg/Cheapli_BEMF.x28FP.mak
Cheapli_BEMF.x28FP: package/cfg/Cheapli_BEMF_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/Cheapli_BEMF_p28FP.o28FP   package/cfg/Cheapli_BEMF_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
Cheapli_BEMF.x28FP: export C_DIR=
Cheapli_BEMF.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
Cheapli_BEMF.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

Cheapli_BEMF.test test,28FP test: Cheapli_BEMF.x28FP.test

Cheapli_BEMF.x28FP.test:: Cheapli_BEMF.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Cheapli_BEMF.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Cheapli_BEMF.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,Cheapli_BEMF.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) Cheapli_BEMF.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Cheapli_BEMF_p28FP.o28FP,copy : package/cfg/Cheapli_BEMF_p28FP.o28FP
Cheapli_BEMF_p28FP.s28FP,copy : package/cfg/Cheapli_BEMF_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Cheapli_BEMF
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Cheapli_BEMF.tar.dep
endif
package/rel/xconfig_Cheapli_BEMF/xconfig_Cheapli_BEMF/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Cheapli_BEMF/xconfig_Cheapli_BEMF/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Cheapli_BEMF/xconfig_Cheapli_BEMF/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Cheapli_BEMF/xconfig_Cheapli_BEMF/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Cheapli_BEMF.tar: package/rel/xconfig_Cheapli_BEMF.xdc.inc package/rel/xconfig_Cheapli_BEMF/xconfig_Cheapli_BEMF/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Cheapli_BEMF.xdc.inc,package/rel/xconfig_Cheapli_BEMF.tar.dep)


release release,xconfig_Cheapli_BEMF: all xconfig_Cheapli_BEMF.tar
clean:: .clean
	-$(RM) xconfig_Cheapli_BEMF.tar
	-$(RM) package/rel/xconfig_Cheapli_BEMF.xdc.inc
	-$(RM) package/rel/xconfig_Cheapli_BEMF.tar.dep
